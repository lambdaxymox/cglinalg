...
mod shear2_tests {
    ...
    fn test_from_shear_xy_point_xy_shearing_plane() {
        ...
        let result = vertices.map(|v| shear.apply_point(&v));
...
mod shear3_coordinate_plane_tests {
    ...
    fn test_from_affine_shear_xy() {
        ...
        let matrix = Shear3::from_affine_shear_xy(shear_factor);
        let vertices = [
    ...
    fn test_from_affine_shear_xz() {
        let shear_factor = 11_i32;
        let matrix = Shear3::from_affine_shear_xz(shear_factor);
        let vertices = [
            Vector4::new( 1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32, -1_i32,  1_i32, 1_i32),
    ...
    fn test_from_affine_shear_yx() {
        let shear_factor = 11_i32;
        let matrix = Shear3::from_affine_shear_yx(shear_factor);
        let vertices = [
            Vector4::new( 1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32, -1_i32,  1_i32, 1_i32),
    ...
    fn test_from_affine_shear_yz() {
        let shear_factor = 11_i32;
        let matrix = Shear3::from_affine_shear_yz(shear_factor);
        let vertices = [
            Vector4::new( 1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32, -1_i32,  1_i32, 1_i32),
    ...
    fn test_from_affine_shear_zx() {
        let shear_factor = 11_i32;
        let matrix = Shear3::from_affine_shear_zx(shear_factor);
        let vertices = [
            Vector4::new( 1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32, -1_i32,  1_i32, 1_i32),
    ...
    fn test_from_affine_shear_zy() {
        let shear_factor = 11_i32;
        let matrix = Shear3::from_affine_shear_zy(shear_factor);
        let vertices = [
            Vector4::new( 1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32,  1_i32,  1_i32, 1_i32),
            Vector4::new(-1_i32, -1_i32,  1_i32, 1_i32),
    ...
    fn test_from_affine_shear_from_affine_shear_xy() {
        ...
        let direction = Unit::from_value(Vector3::unit_x());
        let normal = Unit::from_value(Vector3::unit_y());
        let expected = Shear3::from_affine_shear_xy(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
    ...
    fn test_from_affine_shear_from_affine_shear_xz() {
        ...
        let direction = Unit::from_value(Vector3::unit_x());
        let normal = Unit::from_value(Vector3::unit_z());
        let expected = Shear3::from_affine_shear_xz(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
    ...
    fn test_from_affine_shear_from_affine_shear_yx() {
        ...
        let direction = Unit::from_value(Vector3::unit_y());
        let normal = Unit::from_value(Vector3::unit_x());
        let expected = Shear3::from_affine_shear_yx(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
    ...
    fn test_from_affine_shear_from_affine_shear_yz() {
        ...
        let direction = Unit::from_value(Vector3::unit_y());
        let normal = Unit::from_value(Vector3::unit_z());
        let expected = Shear3::from_affine_shear_yz(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
    ...
    fn test_from_affine_shear_from_affine_shear_zx() {
        ...
        let direction = Unit::from_value(Vector3::unit_z());
        let normal = Unit::from_value(Vector3::unit_x());
        let expected = Shear3::from_affine_shear_zx(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
    ...
    fn test_from_affine_shear_from_affine_shear_zy() {
        ...
        let direction = Unit::from_value(Vector3::unit_z());
        let normal = Unit::from_value(Vector3::unit_y());
        let expected = Shear3::from_affine_shear_zy(shear_factor);
        let result = Shear3::from_affine_shear(shear_factor, &origin, &direction, &normal);
