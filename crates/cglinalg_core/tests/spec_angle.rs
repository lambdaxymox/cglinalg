...
approx_arithmetic_props!(radians_f64_arithmetic_props, Radians, f64, strategy_any_radians, strategy_any_scalar, 1e-10);
approx_arithmetic_props!(degrees_f64_arithmetic_props, Degrees, f64, strategy_any_degrees, strategy_any_scalar, 1e-10);
...
approx_trigonometry_props!(radians_f64_trigonometry_props, Radians, f64, strategy_any_radians, 1e-6);
approx_trigonometry_props!(degrees_f64_trigonometry_props, Degrees, f64, strategy_any_degrees, 1e-6);
...
approx_normalize_props!(radians_f64_normalize_props, Radians, f64, strategy_any_radians, 1e-10);
approx_normalize_props!(degrees_f64_normalize_props, Degrees, f64, strategy_any_degrees, 1e-10);
*/
